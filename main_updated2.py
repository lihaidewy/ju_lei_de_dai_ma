...
from mylib.plot_raw_and_clusters_updated import plot_raw_and_clusters,fit_center_fixed_yaw
...
def render_frame(i: int):
    ...
    for cid in np.unique(labels):
        ...
        if cpts.size == 0:
            continue
        (cx_fit, cy_fit), _ = fit_center_fixed_yaw(cpts, L=4.5, W=2.0, yaw=0.0)
