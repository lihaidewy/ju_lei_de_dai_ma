...
from kalman_cv import update_track
...
def extract_selected_measurement_points(
    ...
    snr_col = _pick_first_existing_column(cluster_df, ["SNR", "snr"])
...
def process_one_target_global_y_prob_weighted(
    ...
    row = {
        ...
        "method": "global_y_prob_weighted_kalman",
        "n_roi": n_roi,
        "n_cluster": n_cluster,
...
def run_global_y_prob_weighted_analysis(
    radar_data,
    gt_df,
    frame_ids,
    cluster_label_map,
